...
const forYou = (props) => {
  ...
  const banners = [ { src: "/banner1.jpg", link: "/shop/fan-gear/springboks?pageName=&page=1&curCursor=&field=DATE&sale=false&parentID=1090&isFeat=false&Order=DESC" }, { src: "/banner2.jpg", link: "https://worldofrugby.co.za/shop/fan-gear/british-and-irish-lions-2021?pageName=&page=1&curCursor=&field=DATE&sale=false&parentID=1183&isFeat=false&Order=DESC" },{ src: "/banner3.jpg", link: "https://www.cashbackworld.com/za/registration/partner/22301001" }, { src: "/banner4.jpg", link: "https://live.mobicred.co.za/cgi-bin/wspd_cgi.sh/WService=wsb_mcrliv/run.w?run=application&merchantID=4311&returnUrl=https://worldofrugby.co.za" }]
  const settings = {
    dots: true,
    infinite: true,
    speed: 1000,
