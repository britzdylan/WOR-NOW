...
const forYou = (props) => {
  ...
  const banners = [
    ...
    },
    {
      src: "/banner3.jpg",
      link:
        "/shop/fan-gear/canterbury-fan-gear?pageName=&page=1&curCursor=&field=DATE&sale=false&parentID=1185&isFeat=false&Order=DESC",
    },
    {
      src: "/banner6.jpg",
      link:
        "/shop/rugby-boots/adidas-boots?pageName=&page=1&curCursor=&field=DATE&sale=false&parentID=791&isFeat=false&Order=DESC",
    },
    {
      src: "/banner7.jpg",
      link:
        "/shop/rugby-boots/puma-boots?pageName=&page=1&curCursor=&field=DATE&sale=false&parentID=792&isFeat=false&Order=DESC",
    },
  ];
  const settings = {
    dots: true,
  ...
  return (
    <div>
      ...
      <CatPreview
        products={featItems}
        catName="Current Sales"
        sale={NotOnSale}
        parentID={216}
        parent={"latest-products"}
      ...
      <div className={classes.catButton}>
        <Link
          href={{
            pathname: `/shop/all-products/featured`,
            query: {
              page: `1`,
              curCursor: ``,
              field: `DATE`,
      ...
      <div className={classes.catButton}>
        <Link
          href={{
            pathname: `/shop/all-products/onsale`,
            query: {
              page: `1`,
              curCursor: ``,
              field: `DATE`,
