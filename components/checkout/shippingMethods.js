    ...
    <>
      <FormControl component="fieldset" className={classes.payments}>
        ...
        >
          {cartTotal > 999 ? (
            <FormControlLabel
              value="free_shipping:6"
              control={<Radio />}
              label="Free Dawnwing Express Delivery"
            />
          ) : null}
          {cartTotal <= 999 ? (
            <FormControlLabel
              value="flat_rate:8"
              control={<Radio />}
              label="Dawnwing Express Delivery at R 150"
            />
          ) : null}
          <FormControlLabel
            value="local_pickup:12"
            control={<Radio />}
            label="Local pick up at WorldofRugby"
          />
        </RadioGroup>
      </FormControl>
    </>
